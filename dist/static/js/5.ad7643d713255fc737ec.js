...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function () {
        const self = this;
        return {
            url: 'http://139.199.202.137:9090/api/category/categorys',
            tableData: [],
            //当前页码
            currPage: 1,
            // 页大小
    ...
    methods: {
        ...
        handleDelete: function (index, row) {
            this.$confirm('确定删除[' + row.name + ']?', '提示', { type: 'warning' }).then(() => {
                ...
                this.$axios.delete('http://139.199.202.137:9090/api/category/' + row.id).then(res => {
                    if (res.data.code == 1) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" 主页")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("目录")])], 1)], 1), _vm._v(" "), _c('el-table', {
    staticStyle: {
      "width": "100%"
    },
    attrs: {
